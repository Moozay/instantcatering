          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="text-gray-700 mb-6">
                Whether you're an airline looking for a catering partner, a business interested in our services, 
            ...
            {/* Map and Contact Info - Right Column */}
            <div className="lg:col-span-6">
              {/* Map */}
              <div className="bg-white shadow-md rounded-lg overflow-hidden mb-8">
                <div className="h-80 w-full">
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39713.079533584!2d-0.4501878419454926!3d51.47002350000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48767234cdc56de9%3A0x8fe7535543f64167!2sHeathrow%20Airport!5e0!3m2!1sen!2suk!4v1668778554043!5m2!1sen!2suk" 
                    width="100%" 
                    height="100%" 
                    style={{ border: 0 }} 
                    allowFullScreen="" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded shadow-md">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-bold mb-1 text-blue-900">Our Location</h3>
                ...
                <div className="bg-white p-4 rounded shadow-md">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-bold mb-1 text-blue-900">Phone Number</h3>
                ...
                <div className="bg-white p-4 rounded shadow-md">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-bold mb-1 text-blue-900">Email Address</h3>
                ...
                <div className="bg-white p-4 rounded shadow-md">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-bold mb-1 text-blue-900">Business Hours</h3>
